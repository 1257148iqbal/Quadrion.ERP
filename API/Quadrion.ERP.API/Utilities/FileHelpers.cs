...
namespace Quadrion.ERP.API.Utilities
{
    public static class FileHelpers
    {
        ...
        public static async Task<byte[]> ProcessFormFile<T>(IFormFile formFile, string[] permittedExtensions, long sizeLimit)
        {
        ...
        public static async Task<byte[]> ProcessStreamedFile(
            MultipartSection section, ContentDispositionHeaderValue contentDisposition, string[] permittedExtensions, long sizeLimit)
        {
            try
            {
                using (var memoryStream = new MemoryStream())
